...
#NO2 Emissions
Ag.For.NO2 <- lme(data = WB_Spread,
                 Ag.NO2 ~ Year + Agriculture + Forest,
                 random = ~1| Country,
                 method = "REML")
summary(Ag.For.NO2)
...
```{r echo=FALSE, fig.cap="\\label{fig:fig6}Change in Emissions Use from 1990 to 2014 for Five Countries", fig.widtch=10, fig.height=10, fig.pos='H', warning= FALSE}
...
grid.arrange(FiveCountries.Meth.NO2, FiveCountries.Facet, FiveCountries.Carbon)

#grid.arrange(FiveCountries.Meth.NO2, FiveCountries.Facet)
